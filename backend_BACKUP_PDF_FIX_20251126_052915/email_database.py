...
def create_patient_invitation(first_name, last_name, email, phone=None):
    ...
    # Default clinic_id (Aberdeen clinic)
    clinic_id = 1
    
    # Default date_of_birth (will be updated during registration)
    ...
    try:
        ...
        """, (patient_number, clinic_id, first_name, last_name, email, 
              phone or '', default_dob, token, expires_at))
